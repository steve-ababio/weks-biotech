    ...
    return (
      <section className="mx-auto my-20">
        <div className="text-center">
            <h2 className="text-[#CE532F] text-4xl font-semibold leading-11 m-5">Meet our team</h2>
            <p className="max-w-3xl w-full mx-auto text-xl text-[#667085] font-normal leading-7.5 mb-9">Our philosophy is simple — hire a team of diverse, passionate people and foster a culture that empowers you to do you best work.</p>
            <button className="bg-[#CE532F] mb-20 mx-auto hidden lg:flex px-5 py-2.5 cursor-pointer rounded-full font-semibold  items-center gap-2 hover:bg-[#a73816]">
